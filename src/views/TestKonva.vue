    ...
    >
      ...
      <v-layer id="floor">
        <v-image
          ...
          :config="image.config"
          :ref="image.id"
          @dragmove="dragMoveFront(image, index, $event)"
      ...
      <v-layer id="front">
                <v-image
          class="selected"
          v-for="(image, index) in frontArtworks"
          v-bind:key="image.id"
          :config="image.config"
          :ref="image.id"
...
console.log("HAYHAYHAYHAY");
        this.frontArtworks.push(artwork);
      ...
      image.src = require("C:/Users/Macache Toto/Pictures/Lizellba/teolski/criquests.png");
      console.log("Yoyoyoyoyo "+image.src);
      console.log("tototo");
  },
};
</script>
